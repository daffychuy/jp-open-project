const Conjugator = require("../middleware/jp-verb-deconjugator/index");
const assert = require("assert");
const WordType = require("../middleware/jp-verb-deconjugator/word_type.js");
const derivations = require("../middleware/jp-verb-deconjugator/derivations.js");
...
describe("Grammar rules", function () {
	it("Works for all grammar rules", function () {
		...
		assertDerivationPathMatches(
			...
			WordType.DA,
			WordType.DAROU,
			WordType.POLITE_DESHOU,
			WordType.NE_PARTICLE,
		);
		...
		assertDerivationPathMatches(
			...
			WordType.OKU,
			WordType.PLAIN_PAST,
			WordType.KOTO_NI_NARU,
			WordType.PLAIN_PAST,
			WordType.EXPLANATORY_NO_PARTICLE,
			WordType.DA,
		);
		...
		assertDerivationPathMatches(
			...
			"返す",
			WordType.PLAIN_PAST,
			WordType.KOTO_NOMINALIZER,
			WordType.DA,
			WordType.EXPLANATORY_NO_PARTICLE,
			WordType.DA,
			WordType.POLITE_DESU_VERB,
			WordType.YO_PARTICLE,
		);
		...
		assertDerivationPathMatches(
			...
			WordType.TE_FORM,
			WordType.MORAU,
			WordType.POLITE_ITADAKU,
			WordType.POTENTIAL,
			WordType.NEGATIVE_NAI_VERB,
			WordType.DAROU,
			WordType.POLITE_DESHOU,
			WordType.KA_PARTICLE,
		);
		assertDerivationPathMatches(
			"離れてもらえないでしょうか",
			"離れる",
